...
export function AuthModal() {
  const { showAuthModal, setShowAuthModal, signIn } = useChatContext();
      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-card border-border">
        <div className="relative">
          ...
          <div className="px-8 pt-10 pb-6 text-center">
            <div className="flex items-center justify-center w-14 h-14 mx-auto mb-4 rounded-2xl bg-accent/10">
            ...
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground mt-2">
                {mode === 'signin'
                  ? 'Sign in to continue with Imagination AI'
                  : 'Join Imagination AI today'}
              </DialogDescription>
            </DialogHeader>
          </div>

# Imagination v1.2.1 — Google Colab
...
```python
!python "/content/drive/MyDrive/imagination-v1.1.0/versions/v1.2.1/colab_setup.py"
```
...
```python
%cd /content/drive/MyDrive/imagination-v1.1.0/versions/v1.2.1
...
```python
%cd /content/imagination-v1.1.0/versions/v1.2.1
import os
os.environ["IMAGINATION_ROOT"] = "/content/imagination-v1.1.0"
!python app.py
```
...
```python
!python "/content/drive/MyDrive/imagination-v1.1.0/versions/v1.2.1/colab_setup.py" --launch
```
